...
6. [User Guide](#user-guide)
   - [Step 1: Verifying GVM Services](#step-1-verifying-gvm-services)
   - [Step 2: Verifying Nikto Installation](#step-2-verifying-nikto-installation)
   - [Step 3: Verifying Nuclei Installation](#step-3-verifying-nuclei-installation)
   - [Step 4: Verifying Metasploit Installation](#step-4-verifying-metasploit-installation)
7. [Launching MedusaGuard](#launching-medusaguard)
   - [Step 1: Navigate to MedusaGuard Directory](#step-1-navigate-to-medusaguard-directory)
   - [Step 2: Run the MedusaGuard Script](#step-2-run-the-medusaguard-script)
8. [Editing Configuration Setup](#editing-configuration-setup)
   - [Step 1: Access the Edit Configuration Page](#step-1-access-the-edit-configuration-page)
   - [Step 2: Fill Out the Configuration Fields](#step-2-fill-out-the-configuration-fields)
9. [Configuring Asset Criticality Score](#configuring-asset-criticality-score)
10. [Running Scans](#running-scans)
    - [Running Scans with the Main Script](#running-scans-with-the-main-script)
11. [Viewing Reports](#viewing-reports)
12. [Scheduling Scans](#scheduling-scans)
    - [Step 1: Access the Scan Scheduler](#step-1-access-the-scan-scheduler)
    - [Step 2: Configure the Schedule](#step-2-configure-the-schedule)
13. [Alternate Execution Method (CLI)](#alternate-execution-method-cli)
    - [Step 1: Navigate to MedusaGuard Directory](#step-1-navigate-to-medusaguard-directory-1)
    - [Step 2: Execute `main.py`](#step-2-execute-mainpy)
    - [Step 3: Running Your First Scan](#step-3-running-your-first-scan)
    - [Step 4: Passing Arguments](#step-4-passing-arguments)
...
15. [Troubleshooting Guide](#troubleshooting-guide)
    - [Externally-Managed Environment During Python Script Execution](#externally-managed-environment-during-python-script-execution)
    - [Greenbone Timeout or Connection Reset Issues](#greenbone-timeout-or-connection-reset-issues)
    - [Socket `/run/gvmd/gvmd.sock` Does Not Exist](#socket-rungvmdgvmdsock-does-not-exist)
    - [Greenbone Connectivity Issues](#greenbone-connectivity-issues)
    - [Permission Denied or Elevated Privileges Required](#permission-denied-or-elevated-privileges-required)
    - [Unable to Detect the URI-Scheme of `<file-path>`](#unable-to-detect-the-uri-scheme-of-file-path)
    - [Report Summary Results not Showing](#report-summary-results-not-showing)
    - [Metasploit RPC Connection Fails](#metasploit-rpc-connection-fails)
    - [Nuclei Update/Scan Fails](#nuclei-updatescan-fails)
    - [Report Generation Errors or Missing Assets](#report-generation-errors-or-missing-assets)
    - [Subprocess `TimeoutExpired` Errors](#subprocess-timeoutexpired-errors)
